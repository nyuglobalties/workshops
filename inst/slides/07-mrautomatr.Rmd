...
- Have you imagined that one day you can get all the tables and plots the second you finish your analysis?
...
- Building consistent and streamlined measure reports for the measurement library and for donors

--

- Efficient generation of intermediate test report for results compiling and internal reporting at any stage of your analysis
...
- It requires *no* prior knowledge in R programming.
...
--
  ...
  - Fill an excel sheet indicating 
...
.aligncenter[### Let's take a look at [**the report**](https://nyu.box.com/s/wy4y4zhoh9tc4sat3bd9x1hoz24gixei)!
]
