...
`broom::tidy` gives you a nice tabular output of your model. Note it also with all the statistical methods I've talked about so far!
...
Note `texreg::texreg` gives you LaTex output and `texreg::screenreg` allows you to quickly see the output in R console. You need to specify `results = "asis"` in the chunk header to knit the results.
